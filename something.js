...
export default function OrderScreen() {
  ...
  return loading ? (
    ...
    <div>
      ...
      <div className="bg-hero-pattern bg-cover bg-no-repeat bg-center w-full mb-2">
        <div className="bg-black/80">
          <NavbarSection />
          <p className="text-gray-200 text-center py-6 text-[2rem] font-bold mx-auto tracking-wide">
            ORDER ID {orderId}
          </p>
        </div>
      </div>
